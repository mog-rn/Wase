...
<html lang="en">
  <head>
    <link rel="icon" href="images/wasify.png" sizes="32x32" type="image/png">
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="register.html" class="cta"><span class="bg-primary text-white rounded">+ Post an Ad</span></a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-8 text-center">
                <h1 class="" data-aos="fade-up">The Best Classifieds You Can Find</h1>
                  ...
                  <div class="col-lg-12 mb-4 mb-xl-0 col-xl-3">
                    <div class="select-wrap">
                      ...
                      <select class="form-control rounded" name="" id="">
                        ...
                        <option value="">Real Estate &amp; housing</option>
          ...
          <div class="row align-items-stretch no-gutters">
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="#" class="popular-category h-100">
                ...
                <span class="caption mb-2 d-block">Real Estate &amp; Housing</span>
            ...
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
              <a href="#" class="popular-category h-100">
                ...
                <span class="caption mb-2 d-block">Electronics, Gadgets &amp; Appliances</span>
                <span class="number">0</span>
              </a>
            </div>
            <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
          ...
          <div class="col-12  block-13">
            <div class="owl-carousel nonloop-block-13">
              ...
              <div class="d-block d-md-flex listing vertical">
                ...
                <div class="lh-content">
                  <span class="category">Real Estate &amp; Housing</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="listings-single.html"></a></h3>
                  <address></address>
                  <p class="mb-0">
              ...
              <div class="d-block d-md-flex listing vertical">
                ...
                <div class="lh-content">
                  <span class="category">Electronics, Gadgets &amp; Appliances</span>
                  <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                  <h3><a href="listings-single.html"></a></h3>
                  <address></address>
                  <p class="mb-0">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              ...
              <div class="listing-item-content">
                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                <a class="px-3 mb-3 category" href="#">Real Estate &amp; Housing</a>
                <h2 class="mb-1"><a href="#"></a></h2>
                <span class="address"></span>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="d-block d-md-flex listing">
              ...
              <div class="lh-content">
                <span class="category">Cars &amp; Vehicles</span>
                <a href="#" class="bookmark"><span class="icon-heart"></span></a>
                <h3><a href="listings-single.html">Luxury Car</a></h3>
                <address></address>
                <p class="mb-0">
                  <span class="icon-star text-warning"></span>
                  <span class="icon-star text-warning"></span>
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <p>&ldquo;This is the best platform that you can use to reach many people...&rdquo;</p>
              </blockquote>
            </div>
          </div>
          <div>
        ...
        <div class="row mb-3 align-items-stretch">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <p>The world is fast changing and as a result the tech is also advancing. And for this reason many businesses have taken a
                huge turn and have started to trade their goods onli...
              </p>
            </div> 
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <div class="meta mb-3">by Mark Spiker<span class="mx-1">&bullet;</span> Jan 18, 2019 <span class="mx-1">&bullet;</span> <a href="#">News</a></div>
              <p>The world is fast changing and as a result the tech is also advancing. And for this reason many businesses have taken a
              huge turn and have started to trade their goods onli...</p>
            </div> 
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
          ...
          <div class="col-12 text-center mt-4">
            <a href="about.html" class="btn btn-primary rounded py-2 px-4 text-white">View All Posts</a>
          </div>
        </div>
      </div>
    </div>
...
<a href="https://thelinks.co.ke/#" class="scrollToTop" style="display: block;"><i class="fa fa-angle-double-up"></i></a>
